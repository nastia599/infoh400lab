...
public class DicomImageViewer extends javax.swing.JFrame {
     ...
     * @param image
     */
    public DicomImageViewer(Image image) {//ici c'est la classe image liée à notre données
        //ce n'est pas l'image dicom ou autre
        initComponents();//on souhaite récupéré cette image depuis dicominstance services donc va dans l'autre package
        //on crée un service dicom pour notre objet image ici
        DicomInstanceServices dis = new DicomInstanceServices(image);//peut recevoir l'image dans un javadwt
        java.awt.Image displayableImage= dis.getImage();
        dicomAttributeTextArea.setText(dis.getAttributesAsString());
        //ajoute ensuite des fonctions à notre image label:
        imageLabel.setIcon(new ImageIcon(displayableImage));
        
        //doit créer le pop up
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(imageLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE))
        );
